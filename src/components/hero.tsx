...
const Hero = () => {
  return (
    <div className="bg-[#F0F2F3] rounded-b-[48px] xl:pb-0 pb-6 sm:mx-10 mx-3 lg:mx-20 lg:h-[600px]">
      <div className="flex sm:flex-row flex-col justify-between items-center md:px-[60px] pt-6 lg:pt-[80px]">
        <div className="flex flex-col justify-center items-center sm:items-start lg:max-w-[557px] md:max-w-[400px] space-y-4 sm:space-y-6 text-[#272343] md:text-left text-center">
          <h1 className="font-bold lg:text-6xl text-3xl mt-3 lg:mt-7">
            Best Oil Collection For Your Hair.
          </h1>
          <Link
            href="/product"
